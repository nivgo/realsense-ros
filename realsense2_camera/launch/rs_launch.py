...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'safety_camera.allow_table_write', 'default': 'false', 'description': "'explicit opt-in required before mount_height/occupancy_cell_size may modify device flash'"},
